                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="content" placeholder="Добавьте контент" rows="10">{{old('content')}}</textarea>
                                    @error('content')
                                    <div class="text-danger">
                                        {{$message}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" value="{{old('price')}}" placeholder="Введите цену">
                                    @error('price')
                                    <div class="text-danger">
                                        {{$message}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="count" name="count" value="{{old('count')}}" placeholder="Введите количество">
                                    @error('count')
                                    <div class="text-danger">
                                        {{$message}}
                                    </div>
